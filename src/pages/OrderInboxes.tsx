    ...
    <MainLayout title="ORDER INBOXES">
      <div className="min-h-[80vh] flex flex-col items-center justify-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl w-full px-4">
          ...
          >
            <div className="bg-[#1A1A1A] border border-gray-800 rounded-xl p-6 h-40 flex flex-col items-center justify-center transition-all duration-300 ease-in-out hover:bg-[#1F1F1F] hover:border-gray-700 hover:shadow-2xl hover:shadow-red-500/10 hover:scale-[1.03]">
              {/* Icon Container */}
          ...
          >
            <div className="bg-[#1A1A1A] border border-gray-800 rounded-xl p-6 h-40 flex flex-col items-center justify-center transition-all duration-300 ease-in-out hover:bg-[#1F1F1F] hover:border-gray-700 hover:shadow-2xl hover:shadow-blue-500/10 hover:scale-[1.03]">
              {/* Icon Container */}
              <div className="flex justify-center mb-4">
                <div className="relative">
